...
- [Safety & Best Practices](#️-safety--best-practices)
...
- Follow folders in numerical order (01 → 07).
- Each folder focuses on a specific Git workflow stage.
...
- [01 – Architecture & Setup](01-architecture-and-setup/)
- [02 – Starting a Project](02-starting-a-project/)
- [03 – Cloning & Working Locally](03-cloning-and-working-locally/)
- [04 – Branching Workflow](04-branching-workflow/)
- [05 – Working with Teammates](05-working-with-teammates/)
...
[Git Commands Cheatsheet](07-git-command-reference/git-commands-cheatsheet.md)
